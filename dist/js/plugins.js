...
class MyPlugin {
    constructor(name, author, description, div, isCommand = true, code = "<TEST CODE>", executeFunction = () => { }) {
        this.name = name;
        this.author = author;
...
savePlugin.addEventListener("click", () => {
    window.api.send("pluginChange", currentPlugin);
})
